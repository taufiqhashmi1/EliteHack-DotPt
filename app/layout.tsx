        ...
        <footer className="w-full border-t border-stone-800 bg-stone-950 mt-auto">
          <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col lg:flex-row justify-between items-start gap-16">
            ...
            <div className="flex flex-col gap-6 max-w-md">
              <Link href="/" className="cursor-magnetic font-serif text-3xl tracking-[0.2em] text-amber-500 uppercase">
                Lumière
              </Link>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-12 text-sm w-full lg:w-auto">
              <div className="flex flex-col gap-5">
                ...
                <Link href="/destinations" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Global Destinations</Link>
                <Link href="/villas" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Private Estates</Link>
                <Link href="/yachts" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Yacht Charters</Link>
                <Link href="/jets" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Aviation</Link>
              </div>
              
              <div className="flex flex-col gap-5">
                <span className="uppercase tracking-[0.2em] text-xs text-stone-100 font-semibold mb-1">Maison</span>
                <Link href="/about" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Our Heritage</Link>
                <Link href="/journal" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">The Journal</Link>
                <Link href="/press" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Press</Link>
                <Link href="/careers" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Careers</Link>
              </div>
              ...
              <div className="flex flex-col gap-5 col-span-2 md:col-span-1">
                ...
                <Link href="/contact" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">Contact Concierge</Link>
                <a href="mailto:inquiries@lumiere.com" className="cursor-magnetic text-stone-400 hover:text-amber-500 transition-colors duration-300">inquiries@lumiere.com</a>
          ...
          <div className="w-full border-t border-stone-900 py-8 flex flex-col md:flex-row items-center justify-between px-6 max-w-7xl mx-auto text-stone-500 text-xs tracking-[0.1em] uppercase">
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
              ...
              <div className="flex gap-4">
                <Link href="/privacy" className="cursor-magnetic hover:text-amber-500 transition-colors duration-300">Privacy</Link>
                <Link href="/terms" className="cursor-magnetic hover:text-amber-500 transition-colors duration-300">Terms</Link>
              </div>
            </div>
          </div>
        </footer>
